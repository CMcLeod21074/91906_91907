...
###!!!!FIX LOGIN ON REPLAY RESET THING!!!!!###



#Sort works - but not with format from gameplay --- fix double game over -- also incorrect gameover#!!!!!
#FIx same username highscore double error
...
shapes_easy = [
    ...
    {"level": "easy", "type": "area", "shape": "triangle", "base": 12, "height": 5, "image": "images/easy/area/t12x5.png"},
...
def verify_answer(): #Function that checks if the users input is the correct answer
...
#    print("APPENDING")
    ...
    for line in highscore_database:
        ...
        if compare_username == login_username:
            print("Matching Name")
...
def display(event):
    ...
    sort2 = open("text files/highscore sort 2.txt","r")
...
def welcome():
    start_button = tk.Button(welcome_window, text="TEMP ", bg="#c1f0c1", fg="black", font=("Times New Roman",10))
...
def play_again():
    ...
    if username_label.winfo_exists() and level_label.winfo_exists() and display_question_label.winfo_exists():
...
mouse_image = Image.open("images/characters_background/mouse.png")
